  ...
  return (
    <>
      ...
      <main>
        ...
        <RectReverse id={'Histórico'} title={'Historico'} text={'Eu já trabalhei como aprendiz na rede de supermercados Angeloni, fiquei um tempo como atendente em uma papelaria e, atualmente, estou trabalhando como aprendiz em soluções digitais na Bosch.'} photo={'img/boschLogo.png'}></RectReverse>
      </main>
